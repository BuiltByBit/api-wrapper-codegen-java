...
import org.openapitools.client.api.ResourcesCreatorBatchApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    ResourcesCreatorBatchApi apiInstance = new ResourcesCreatorBatchApi(defaultClient);
    ...
    try {
      ...
      System.err.println("Exception when calling ResourcesCreatorBatchApi#getV2ResourcesCreatorBatch");
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling ResourcesCreatorBatchApi#postV2ResourcesCreatorBatch");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
